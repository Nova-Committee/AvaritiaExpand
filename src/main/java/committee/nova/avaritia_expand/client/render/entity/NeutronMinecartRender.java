...
public class NeutronMinecartRender <T extends NeutronMinecart> extends EntityRenderer<T> {

    private static final ResourceLocation MINECART_LOCATION = AvaritiaExpand.rl("textures/entity/neutron_minecart/neutron_minecart.png");
    protected final EntityModel<T> model;
    private final BlockRenderDispatcher blockRenderer;

    public NeutronMinecartRender(EntityRendererProvider.Context context) {
        super(context);
