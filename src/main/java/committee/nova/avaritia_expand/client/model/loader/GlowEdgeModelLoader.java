...
import committee.nova.avaritia_expand.client.model.GlowEdgeBakedModel;
...
public class GlowEdgeModelLoader implements IGeometryLoader<GlowEdgeModelLoader.GlowEdgeGeometry> {
    ...
    public static class GlowEdgeGeometry implements IUnbakedGeometry<GlowEdgeGeometry> {
        ...
        @Override
        public BakedModel bake(IGeometryBakingContext iGeometryBakingContext, ModelBaker baker, Function<Material, TextureAtlasSprite> spriteGetter, ModelState modelState, ItemOverrides itemOverrides) {
